...
<div class="card">
    ...
    <div class="card-block m-t-35">
        ...
        <form class="form-horizontal login_validator bv-form" id="tryitForm" action="{{ route('createclient')}}" method="post" novalidate="novalidate">
        {{ csrf_field() }}
        <button type="submit" class="bv-hidden-submit" style="display: none; width: 0px; height: 0px;"></button>
            ...
            <div class="row">
                ...
                <span class="input-group-addon"> <i class="fa fa-user text-primary"></i>
                                ...
                                <input type="text" name="name" id="u-name" class="form-control" data-bv-field="name" required = "">
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder=" " id="email" name="email" class="form-control" data-bv-field="email" required = "">
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder=" " id="phone" name="phone" class="form-control" data-bv-field="cell" required = "">
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="custom-controls-stacked">
                                <label class="custom-control custom-radio">
                                    <input id="radio1" type="radio" name="gender" class="custom-control-input" data-bv-field="gender" value="Male">
                                    <span class="custom-control-indicator"></span>
                                    <span class="custom-control-description">Male</span>
                                </label>
                                <label class="custom-control custom-radio">
                                    <input id="radio2" type="radio" name="gender" class="custom-control-input" data-bv-field="gender" value="Female">
                                    <span class="custom-control-indicator"></span>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="input-group">
                                ...
                                <input type="text" placeholder=" " id="address" name="address" class="form-control" data-bv-field="address1" required = "">
                            </div>
                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="address1" data-bv-result="NOT_VALIDATED" style="display: none;">Enter your address</small></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3 text-lg-right">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-plus text-primary"></i></span>
                                <input type="text" placeholder=" " name="city" id="city" class="form-control" data-bv-field="city" required = "">
                            </div>
                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="city" data-bv-result="NOT_VALIDATED" style="display: none;">City is required = ""</small></div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-3 text-lg-right">
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-plus text-primary"></i></span>
                                <input type="text" placeholder=" " name="pincode" id="pincode" class="form-control" data-bv-field="pincode" required = "">
                            </div>
                        <small class="help-block" data-bv-validator="notEmpty" data-bv-for="pincode" data-bv-result="NOT_VALIDATED" style="display: none;">Pincode number is required = ""</small><small class="help-block" data-bv-validator="regexp" data-bv-for="pincode" data-bv-result="NOT_VALIDATED" style="display: none;">Enter valid Pincode number</small></div>
                    </div>
